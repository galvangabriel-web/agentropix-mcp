...
| **MCP** | Model Context Protocol; the integration substrate for every `mcp_*` tool. The FastMCP server exposes **73** distinct tools. | AGENTS.md; canonical-facts.md |
...
| **W-113** | MCP-100% campaign anchor — definition-of-done for the 73-tool surface. | AGENTS.md |
