...
> values — **72 MCP tools, 16 SIFT forensic tools, 4464 tests, 72/72 disk
...
- [Canonical facts](canonical-facts.md) — the numeric source of truth (72 tools, 16 SIFT tools, 4464 tests, 72/72 recall).
