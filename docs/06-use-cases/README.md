...
9. [assets/srl-2018-execution/execution-report-srl-2018.md](assets/srl-2018-execution/execution-report-srl-2018.md) — the runbook **executed live** against `/cases/SRL-2018/`: MP4 of the shell layer + a real sealed autonomous run, with coverage matrix and diagrams.
