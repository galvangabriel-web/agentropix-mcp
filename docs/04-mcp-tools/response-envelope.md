...
> **What a tool call actually returns.** Every one of the [73 MCP tools](tool-reference.md) returns a
...
- [Tool reference](tool-reference.md) — the master categorized index of all 73 tools, with the
...
- [Canonical facts](../08-reference/canonical-facts.md) — oracle figures (73 tools, 16 wrappers, …) used throughout this page.
