...
- **Analyst / reviewer** (see real report output): **[Multi-Tier Report Engine — example reports](2026-06-01-report-engine-design/GENERATED-REPORTS-INDEX.md)** — ADR-024's report engine projecting one case into **Analyst · Executive · Business** tiers (each in **md / html / pdf**), generated live for 4 cases and grounded in real findings/IOCs/timeline. Includes the design docs (ADR-024, plan, readiness) and a native-vs-multi-tier contrast. *(CTF/training case data; reports embed real artifact citations.)*
