...
[![memdump (raw 2014) executed run — poster frame (click for the MP4)](executed-run-poster.png)](https://galvangabriel-web.github.io/agentropix-mcp/case-activation/runs/memdump-raw-2014/EXECUTED-RUN.mp4)
