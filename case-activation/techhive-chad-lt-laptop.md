...
> ⚠️ **Load-bearing caveat — BitLocker.** The platform's **73 MCP tools include no BitLocker
...
Both lanes hit the **same 73-tool deterministic MCP engine** and reach the same sealed result — only
