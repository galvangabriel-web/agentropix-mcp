...
> canonical numbers in [`.crew/facts.md`](../docs/08-reference/canonical-facts.md) (73 MCP tools, 16 SIFT wrappers, 4687
...
2. 💬 *"How many Agentropix forensic tools are available right now?"*
   ...
   **Expect:** live `tool_count` (canonical **73**; a live server may report **73** — trust the live number, not the banner).
...
- **73** MCP tools / **16** SIFT forensic wrappers / **4687** tests — `.crew/facts.md`
